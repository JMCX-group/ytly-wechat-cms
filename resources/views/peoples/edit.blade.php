    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-info">
                <form class="form-horizontal" action="{{URL::to('hospital/'.$hospital->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="city" name="city" placeholder="所属城市" value="{{$hospital->city}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" name="name" placeholder="医院名称" value="{{$hospital->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control select2" name="three_a">
                                    <option value="Y" @if($hospital->three_a=="Y") selected @endif>Y</option>
                                    <option value="N" @if($hospital->three_a=="") selected @endif>N</option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control select2" name="status" title="状态">
                                    <option value="已核实" @if($hospital->status=="已核实") selected @endif>已核实</option>
                                    <option value="待核实" @if($hospital->status=="待核实") selected @endif>待核实</option>
                                    <option value="已拒绝" @if($hospital->status=="已拒绝") selected @endif>已拒绝</option>
                                    <option value="已删除" @if($hospital->status=="已删除") selected @endif>已删除</option>
                                </select>
