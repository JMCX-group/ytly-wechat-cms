...
<style type="text/css">
    ...
    .icon_audio_playing {
        background: transparent url('/assets/images/audio_play_icon_playing.png') no-repeat 0 0;
        width: 18px;
        height: 25px;
    ...
    .icon_audio_bkg {
        background: transparent url('/assets/images/audio_play_icon_bkg.png') no-repeat 0 0;
